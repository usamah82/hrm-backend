module Inputs
  module Company
    ...
    class CreateCompanyInput < Inputs::BaseInput
      attr_accessor :administrator_email, :administrator_name, :company_name, :company_country_code
      ...
      validates :company_country_code, presence: true # TODO - must be valid country code
    end
  end
end
